...
exports.RingBufferUint8 = void 0;
class RingBufferUint8 {
    _addressFirstByte = 0;
    _countStoredBytes = 0;
    _bufferSize; //Like this._buffer.length, but may be faster
    _buffer;
    _flagOverwrite;
    /**
     ...
     */
    constructor(sizeBytes, flagOverwrite = false) {
     ...
     */
    set flagOverwrite(flagOverwrite) {
        this._flagOverwrite = flagOverwrite;
    }
    /**
    ...
    static assertByteToWrite(valueOneByte, functionName, functionCode) {
        if (!(valueOneByte <= 255))
            throw new (class extends Error {
     ...
     */
    _writeByteAtBegin(indexAtBegin, valueOneByte) {
     ...
     * @throws {Error} - Throws an error if the index is out of bounds.
     */
    writeByteAtBegin(indexAtBegin, valueOneByte) {
        if (!(indexAtBegin <= this._countStoredBytes))
            throw new (class extends Error {
     ...
     * @param {number} valueOneByte - The value of the byte to write.
     */
    _writeByteAtEnd(indexAtEnd, valueOneByte) {
     ...
     * @throws {Error} - Throws an error if the index is out of bounds.
     */
    writeByteAtEnd(indexAtEnd, valueOneByte) {
        if (!(indexAtEnd <= this._countStoredBytes))
            throw new (class extends Error {
     ...
     */
    pushByte(valueOneByte, overwrite = this._flagOverwrite) {
    ...
    shiftUint8Array(countBytesToShift = undefined) {
     ...
     * false - not equals
     * */
    isEndWithUint8array(uint8Array) {
    ...
    //     return false;
    // }
    ifEndsWithUint8ArrayThenFlushUint8Array(separatorUint8Array, returnWithSeparator = true) {
    ...
    ifEndsWithUint8ArraysThenFlushUint8Array(uint8Arrays, returnWithSeparator = true) {
    ...
    pushUint8ArrayIfEndsWithUint8ArraysThenFlushUint8Array(pushBytes, endWithSplitters, returnWithSeparator = true, callback) {
